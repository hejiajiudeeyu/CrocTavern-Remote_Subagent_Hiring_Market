# Contributing to Croc Tavern

感谢你参与 Croc Tavern | Remote Subagent Hiring Market。

本仓库当前处于 MVP 设计与实现早期，贡献目标是快速验证 Remote Subagent 雇佣闭环，而不是一次性做完整生产系统。

## 1. 贡献范围

欢迎以下类型贡献：
- 文档与接口规范完善（`docs/`）
- Buyer/Seller 模板实现与示例
